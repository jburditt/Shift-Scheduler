...
class Calendar {
    ...
    *********************************************************************************/
    ...
    function getMonthHTML($m, $y, $showYear = 1) {
    	...
    	$s .= "<table class=\"calendar\" cellspacing=\"1\" cellpadding=\"0\">\n";
    	$s .= "<tr class=\"calHeader\">\n";
    	$s .= "<td align=\"center\">" . (($prevMonth == "") ? "&nbsp;" : "<a href=\"$prevMonth\">&lt;&lt;</a>")  . "</td>\n";
    	$s .= "<td align=\"center\" class=\"calendarHeader\" colspan=\"5\"><b>$header</b></td>\n"; 
    	$s .= "<td align=\"center\">" . (($nextMonth == "") ? "&nbsp;" : "<a href=\"$nextMonth\">&gt;&gt;</a>")  . "</td>\n";
    	$s .= "</tr>\n";
    	
    	$s .= "<tr>\n";
    	$s .= "<td align=\"center\" valign=\"top\" class=\"monthCell Cell\"><b>" . $this->dayNames[($this->startDay)%7] . "</b></td>\n";
    	$s .= "<td align=\"center\" valign=\"top\" class=\"monthCell Cell\"><b>" . $this->dayNames[($this->startDay+1)%7] . "</b></td>\n";
    	$s .= "<td align=\"center\" valign=\"top\" class=\"monthCell Cell\"><b>" . $this->dayNames[($this->startDay+2)%7] . "</b></td>\n";
    	$s .= "<td align=\"center\" valign=\"top\" class=\"monthCell Cell\"><b>" . $this->dayNames[($this->startDay+3)%7] . "</b></td>\n";
    	$s .= "<td align=\"center\" valign=\"top\" class=\"monthCell Cell\"><b>" . $this->dayNames[($this->startDay+4)%7] . "</b></td>\n";
    	$s .= "<td align=\"center\" valign=\"top\" class=\"monthCell Cell\"><b>" . $this->dayNames[($this->startDay+5)%7] . "</b></td>\n";
    	$s .= "<td align=\"center\" valign=\"top\" class=\"monthCell Cell\"><b>" . $this->dayNames[($this->startDay+6)%7] . "</b></td>\n";
    	$s .= "</tr>\n";
    	...
    	while ($d <= $daysInMonth) {
    	    ...
    	    for ($i = 0; $i < 7; $i++) {
        	    $class = ($year == $today["year"] && $month == $today["mon"] && $d == $today["mday"]) ? "dayTodayCell Cell" : "dayCell Cell";
    	        if ($d <= 0 || $d > $daysInMonth) $class = "dayOtherCell Cell";
